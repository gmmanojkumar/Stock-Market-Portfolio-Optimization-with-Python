...
# Split 'Attribute_Ticker' into separate columns
...
# Save to CSV
csv_path = r"C:\Users\DELL\Downloads\stock_data.csv"
...
# Load the CSV file
stock_data = pd.read_csv(r"C:\Users\DELL\Downloads\stock_data.csv")
...
# Reset index (optional for plotting)
...
for ticker in unique_tickers:
    ...
    # Compute moving averages on 'Close' instead of missing 'Adj Close'
...
for i in range(num_portfolios):
    ...
    results[2, i] = port_return / port_vol  # Sharpe Ratio
